...
const socialLinks = [
  ...
  {
    href: "https://www.linkedin.com/in/kisibo-jonathan-3699ab33b?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BCIq%2FdIhVQVuF9UgUr%2F54Ow%3D%3D",
    icon: Linkedin,
    label: "LinkedIn",
  },
        ...
        <div className="flex flex-col items-center gap-8 md:flex-row md:justify-between">
          <div className="flex flex-col items-center gap-4 md:items-start animate-fade-in">
            ...
            >
              ...
              />
              <span className="text-transparent bg-clip-text bg-linear-to-r from-accent   to-orange-500">
                KISIBO JONATHAN
              </span>
            </Link>
